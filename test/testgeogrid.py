...
class TestGeoGrid(unittest.TestCase):
   ...
   #          self.assertTrue(np.all(slc1.mask == slc2.mask))
    ...
    def test_getitemOrigin(self):
        grids = (
            gg.ones((100,100),yorigin=6757,xorigin=767666,origin="ul"),
            gg.ones((33,100,100),yorigin=6757,xorigin=767666,origin="ul")
        )
        ...
        slices = (
            ...
            -1,
            #(-23,-22),
            (Ellipsis,slice(44,None,None),slice(None,66,80)),
        )
        
        for grid in grids:
            for slc in slices:
                new = grid[slc]
                print grid.yorigin,grid.xorigin
                print new.yorigin, new.xorigin
            break
